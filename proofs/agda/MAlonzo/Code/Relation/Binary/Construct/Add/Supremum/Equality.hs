...
name22 = "Relation.Binary.Construct.Add.Supremum.Equality._._≈∙_"
...
name28 = "Relation.Binary.Construct.Add.Supremum.Equality._.≈∙-dec"
d28 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  ...
  = coe
      (\ v0 v1 v2 v3 v4 v5 ->
         MAlonzo.Code.Relation.Binary.Construct.Add.Point.Equality.du96
           v1 v2 v3 v4 v5)
name40 = "Relation.Binary.Construct.Add.Supremum.Equality._.≈∙-sym"
d40 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
