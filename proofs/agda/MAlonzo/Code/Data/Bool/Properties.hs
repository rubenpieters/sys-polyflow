...
d1386 :: MAlonzo.Code.Algebra.T416
d1386
  = coe
...
d1390 :: MAlonzo.Code.Algebra.T494
d1390
  = coe
      (\ v0 v1 v2 v3 v4 -> MAlonzo.Code.Algebra.C2007 v2 v3 v4) erased
      erased MAlonzo.Code.Data.Bool.Base.d30
...
d1504 :: MAlonzo.Code.Algebra.T416
d1504
  = coe
      (\ v0 v1 v2 v3 v4 -> MAlonzo.Code.Algebra.C1695 v2 v3 v4) erased
...
d1508 :: MAlonzo.Code.Algebra.T494
d1508
  = coe
      (\ v0 v1 v2 v3 v4 -> MAlonzo.Code.Algebra.C2007 v2 v3 v4) erased
      erased MAlonzo.Code.Data.Bool.Base.d24
...
d1512 :: MAlonzo.Code.Algebra.T1690
d1512
  = coe
...
d1516 :: MAlonzo.Code.Algebra.T1690
d1516
  = coe
      (\ v0 v1 v2 v3 v4 v5 v6 ->
         MAlonzo.Code.Algebra.C6707 v2 v3 v4 v5 v6)
...
d1520 :: MAlonzo.Code.Algebra.T880
d1520
  = coe
...
d1524 :: MAlonzo.Code.Algebra.T950
d1524
  = coe
...
d1528 :: MAlonzo.Code.Algebra.T2254
d1528
  = coe
      (\ v0 v1 v2 v3 v4 v5 v6 v7 ->
         MAlonzo.Code.Algebra.C8967 v2 v3 v4 v5 v6 v7)
      erased erased MAlonzo.Code.Data.Bool.Base.d30
...
d1540 :: MAlonzo.Code.Algebra.T2058
d1540
  = coe
...
d1974 :: MAlonzo.Code.Algebra.T1690
d1974 = coe d1512
...
d1978 :: MAlonzo.Code.Algebra.T1690
d1978 = coe d1516
...
d1982 :: MAlonzo.Code.Algebra.T2254
d1982 = coe d1528
name1984 = "Data.Bool.Properties.commutativeRing-xor-∧"
d1984 :: MAlonzo.Code.Algebra.T2058
d1984 = coe d1540
