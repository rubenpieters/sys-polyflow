...
du124 v0
  = coe
      (MAlonzo.Code.Data.Nat.Properties.du1752 (coe (du106 (coe v0))))
...
du222 v0
  = coe
      (MAlonzo.Code.Data.Nat.Properties.d1328
...
du230 ::
  MAlonzo.Code.Data.Nat.Base.T6 ->
  MAlonzo.Code.Data.Nat.Base.T6 -> MAlonzo.Code.Data.Nat.Base.T6
du230 = coe MAlonzo.Code.Data.Nat.Properties.du1336
...
du242 v0 v1
  = coe
      (MAlonzo.Code.Data.Nat.Properties.d1342
         (coe (MAlonzo.Code.Data.Fin.Base.du20 (coe v0)))
...
du250 v0 v1
  = coe
      (MAlonzo.Code.Data.Nat.Properties.d1370
         (coe (MAlonzo.Code.Data.Fin.Base.du20 (coe v0)))
         (coe (MAlonzo.Code.Data.Fin.Base.du20 (coe v1))))
...
du310 v0
  = coe
      (MAlonzo.Code.Data.Nat.Properties.du1556
         (coe (MAlonzo.Code.Data.Fin.Base.du20 (coe v0))))
...
du600 v0 v1
  = case coe v1 of
      MAlonzo.Code.Data.Fin.Base.C382 v3
        -> coe
             (MAlonzo.Code.Data.Nat.Properties.du4136
        ...
        -> let v4 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du160
                (coe MAlonzo.Code.Data.Nat.Properties.d1394)
                (coe MAlonzo.Code.Data.Nat.Properties.d1442)
                (coe
                   (MAlonzo.Code.Data.Fin.Base.d318
                      (coe v0)
                ...
                (coe
                   (MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du228
                      (coe MAlonzo.Code.Data.Nat.Properties.d1394)
                      (coe MAlonzo.Code.Data.Nat.Properties.d1562)
                      (coe (MAlonzo.Code.Data.Fin.Base.d318 (coe v4) (coe v3))) (coe v4)
                      (coe v0) (coe (d662 (coe v4) (coe v3)))
                      (coe
                         (MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du228
                            (coe MAlonzo.Code.Data.Nat.Properties.d1394)
                            (coe MAlonzo.Code.Data.Nat.Properties.d1562) (coe v4) (coe v0)
                            (coe v0) (coe (MAlonzo.Code.Data.Nat.Properties.d1430 (coe v4)))
                            (coe
