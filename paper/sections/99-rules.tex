...
\inferrule*[right=T-IfTrue]
           { \typeincontext{x}{X}{\Gamma} \\ \subtypeincontext{X}{T}{\Gamma} \\ \hassubtype{\Gamma}{T}{Bool} \\ \infers{\extendwsubtype{\Gamma}{\ttrue}{X}}{t_2}{A} \\ \infers{\extendwsubtype{\Gamma}{\tfalse}{X}}{t_3}{B} }
