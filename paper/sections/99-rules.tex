...
\inferrule*[right=S-TEval1]
           { \teval{\Gamma}{T_1}{T_2} }
           { \hassubtype{\Gamma}{T_1}{T_2} }

\inferrule*[right=S-TEval2]
           { \teval{\Gamma}{T_1}{T_2} }
           { \hassubtype{\Gamma}{T_2}{T_1} }
...
\inferrule*[right=TE-MapTrueSub]
           { \isatleast{\Gamma}{True}{T} }
           { \teval{\Gamma}{\tmap{T_t}{T_f}{T}}{T_t} }

\inferrule*[right=TE-MapFalse]
           {  }
           { \teval{\Gamma}{\tmap{T_t}{T_f}{\tfalse}}{T_f} }

\inferrule*[right=TE-MapFalseSub]
           { \isatleast{\Gamma}{False}{T} }
           { \teval{\Gamma}{\tmap{T_t}{T_f}{T}}{T_f} }
